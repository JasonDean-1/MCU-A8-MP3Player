 ...
 *	   功能：
 			 ...
 			 k3:上一首
 			 k4:下一首
 *     附加：歌曲自动循环播放SD卡/sdcard/musics目录中mp3歌曲
 *
...
int main(void)
{
    ...
    printf("\n");
    printf("+-----------------------------------------------------------------------+\n");
	printf("+             基于mini2440/micro2440开发板的SD卡MP3播放器系统           +\n");
	printf("+                    最诚实商家: http://www.broadon.cn                  +\n");
	printf("+             北京博航嵌入式:  http://armdspfpga.taobao.com/            +\n");
    printf("+-----------------------------------------------------------------------+\n");
    printf("\n");
